        ...
        <form>
            <div className="d-flex mt-4 w-100 justify-content-around">
                <div className="form-floating">
                    <input type="text" className="form-control " id="floatingInput" onChange={e => setLastname(e.target.value)}/>
                    <label htmlFor="floatingInput">Nom</label>
                </div>
                <div className="form-floating">
                    <input type="text" className="form-control " id="floatingInput" onChange={e => setFirstname(e.target.value)}/>
