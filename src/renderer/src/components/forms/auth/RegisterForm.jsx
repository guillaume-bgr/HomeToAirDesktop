            ...
            <div className="row mx-5 pt-4">
                <div className="col-6">
                    <div className="form-floating">
                        <input type="text" className="form-control form-input-solid" id="floatingInput" onChange={e => setLastname(e.target.value)}/>
                        <label htmlFor="floatingInput">Nom</label>
                    </div>
                </div>
                <div className="col-6">
                    <div className="form-floating">
                        <input type="text" className="form-control form-input-solid" id="floatingInput" onChange={e => setFirstname(e.target.value)}/>
                ...
                <div className="col-12 mt-4">
                    <div className="form-floating">
                        <input type="password" className="form-control connect-input" id="floatingPassword" onChange={e => setPassword(e.target.value)}/>
                        <label htmlFor="floatingPassword">Mot de passe</label>
                    </div>
                </div>
                <div className="col-12 mt-4">
                    <div className="form-floating">
                        <input type="password" className="form-control connect-input" id="floatingPassword" onChange={e => setRepeatPassword(e.target.value)}/>
